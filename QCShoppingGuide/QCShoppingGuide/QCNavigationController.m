...
@interface QCNavigationController ()<UIGestureRecognizerDelegate>
...
+(void)initialize{
    //当导航栏使用QCNavigationController时才设定主题
    UINavigationBar *navigationBar = [UINavigationBar appearanceWhenContainedInInstancesOfClasses:@[[QCNavigationController class]]];
    
    //设置背景图片
    navigationBar.barTintColor = kGlobalBg;
